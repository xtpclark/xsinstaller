...
DEPS='awscli jq s3cmd wget'
DIRS='planin xtupledb route53 report scripts certs logs mail custlogs sql'
...
if [ $SSLCHK = 0 ]
 then
  ...
  echo "This might cause a problem"
 else
...
XTDOMAIN=xtuplecloud.com
AWSDNSALIAS="nova4.xtuplecloud.com"
AWSZONEID=ZCU8EE8ESLJQD
XTADMIN=admin
